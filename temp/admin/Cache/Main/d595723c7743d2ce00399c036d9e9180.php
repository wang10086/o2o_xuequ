            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('System/config');?>">网站配置</a></li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right box-tools">
                                        ...
                                        <a href="<?php echo U('System/edit_config',array('show'=>1));?>"  class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 新增配置</a>
                                        <?php } ?>
                                        <?php if(!$show){ ?>
                                        <a href="<?php echo U('System/config',array('show'=>1));?>"  class="btn btn-info btn-sm">显示全部</a>
                                        <?php } ?>
                                    </div>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <table class="table table-bordered dataTable fontmini" id="tablelist">
                                    	<tr role="row" class="orders" >
                                            ...
                                            <th width="180">标识</th>
                                            <th>内容</th>
                                            <?php if(rolemenu(array('System/edit_config'))): ?><th width="60" class="taskOptions">编辑</th><?php endif; ?>
                                        ...
                                        <?php if(is_array($datalist)): foreach($datalist as $key=>$row): ?><tr>
                                            <td><?php echo ($row["conf_explain"]); ?></td>
                                            <td><?php echo ($row["conf_key"]); ?></td>
                                            <td><?php echo ($row["conf_val"]); ?></td>
                                            <?php if(rolemenu(array('System/edit_config'))): ?><td class="taskOptions">
                                                <button onClick="javascript:window.location.href='<?php echo U('System/edit_config',array('id'=>$row['id']));?>';" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></button>
                                            </td><?php endif; ?>
                                            <?php if($show && rolemenu(array('Delete/del_config'))){ ?>
                                            <td class="taskOptions">
                                                <a onClick="javascript:ConfirmDel('<?php echo U('Delete/del_config',array('id'=>$row['id']));?>');" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></a>
                                            </td>
                                            <?php } ?>
