            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('System/kind');?>">栏目管理</a></li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right box-tools">
                                        ...
                                        <a href="<?php echo U('System/kind_edit',array('type'=>$type));?>" class="btn btn-danger btn-sm" style="color:#ffffff;"><i class="fa fa-plus"></i> 新增栏目</a>
                                    </div>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                	<div class="btn-group" id="catfont">
                                    	<?php if(is_array($kindtype)): foreach($kindtype as $k=>$v): ?><a href="<?php echo U('System/kind',array('type'=>$k));?>" class="btn <?php if($k==$type){ echo 'btn-info';}else{ echo 'btn-default';} ?> "><?php echo ($v); ?></a><?php endforeach; endif; ?>
                                    </div>
                                    ...
                                    <table class="table table-bordered dataTable fontmini" id="listtable" style="margin-top:10px;">
                                        <tr role="row">
                                            ...
                                            <th>栏目名称</th>
                                            <th width="100">状态</th>
                                            <?php if(rolemenu(array('System/kind_edit'))): ?><th width="60" class="taskOptions">修改</th><?php endif; ?>
                                            <?php if(rolemenu(array('System/kind_del'))): ?><th width="60" class="taskOptions">删除</th><?php endif; ?>
                                        </tr>
                                        <?php if(is_array($datalist)): foreach($datalist as $key=>$row): ?><tr>
                                            <td style="height:36px; line-height:36px;"><?php echo ($row["id"]); ?></td>
                                            <td style="height:36px; line-height:36px;"><?php echo ($row["sort"]); ?></td>
                                            <td style="height:36px; line-height:36px;"><?php echo ($row["tab"]); ?> <?php echo ($row["title"]); ?></td>
                                            <td style="height:36px; line-height:36px;" <?php if(rolemenu('Index/opstatus')){ ?> onClick="opstatus('<?php echo ($row["id"]); ?>','kind','status','6',this)" <?php } ?>>
                                          	
                                          	<?php if($row['status']){ echo '<span class="green">已启用</span>';}else{ echo '<span class="red">已停用</span>';} ?>
                                            </td>
                                            <?php if(rolemenu(array('System/kind_edit'))): ?><td class="taskOptions"  style="height:36px; line-height:36px;">
                                            	<a href="<?php echo U('System/kind_edit',array('id'=>$row['id'],'type'=>$type));?>" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td><?php endif; ?>
                                            <?php if(rolemenu(array('System/kind_del'))): ?><td class="taskOptions"  style="height:36px; line-height:36px;">
                                                <a onClick="javascript:ConfirmDel('<?php echo U('System/kind_del',array('id'=>$row['id']));?>');" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></a>
                                            </td><?php endif; ?>
