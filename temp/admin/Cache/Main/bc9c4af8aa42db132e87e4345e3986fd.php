...
<aside class="left-side sidebar-offcanvas" id="indexmenus">
    ...
    <!-- /.sidebar -->
                                ...
                                <div class="box-body">
                                    <table class="table table-bordered dataTable fontmini" id="tablelist">
                                        ...
                                        <?php if(is_array($users)): foreach($users as $key=>$row): ?><tr>
                                        	<td align="center"><img src="<?php echo ($row["avatar"]); ?>" width="36" style="border-radius:36px;"></td>
                                        	<td style="line-height:36px;"><?php echo ($row["id"]); ?></td>
											<!--<td style="line-height:36px;"><?php ?></td>-->
											<td style="line-height:36px;"><?php echo urldecode($row['username']); ?></td>
                                            <td style="line-height:36px;"><?php echo ($row["mobile"]); ?></td>
                                            <td style="line-height:36px;"><?php echo ($row["email"]); ?></td>
											<td style="line-height:36px;"><?php if($row['last_login_time']): echo (date('Y-m-d H:i:s',$row["last_login_time"])); endif; ?></td>
                                            <td style="line-height:36px;"><?php if($row['reg_time']): echo (date('Y-m-d H:i:s',$row["reg_time"])); endif; ?></td>
                                            <td style="line-height:36px;"><?php echo ($row["strlevel"]); ?></td>
                                            <td style="line-height:36px; text-align: center;"><a href="<?php echo U('Member/Member_del',array('id'=>$row['id']));?>" onclick="return del()" title="删除" class="btn btn-del btn-smsm"><i class="icon ion-close-circled"></i>删除</a></td>
        ...
        <div id="searchtext">
            <form method="get" action="<?php echo U('Member/index');?>" id="searchfrom" name="myform">
