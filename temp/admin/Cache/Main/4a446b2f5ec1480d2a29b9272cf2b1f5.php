                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="margin-top:20px;">
                            <form method="post" action="<?php echo U('News/pic_add');?>" name="myform" id="myform">
                                ...
                                <div class="form-group col-md-12">
                                    <label>上传标题图片</label>
                                    <?php echo upload_m('uploadfile','files',$atts,'上传标题图片');?>
                                </div>

                                <div style="display:none" id="task_val">0</div>
                                <label style="margin-left: 15px;">上传内容图片</label>
                                <?php echo upload_m('daysfile','daysfiles',$atts,'&nbsp;内容照片','daysbox','daypic','内容图片');?>
                                <div id="daysbox"></div>
