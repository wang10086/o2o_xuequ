    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Apply/apply_sci');?>">研学/科学课程预约记录</a></li>
            </ol>
        </section>
                        ...
                        <div class="box-body">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$row): ?><tr>
                                        ...
                                        <?php if($row[type] == 1): ?><td class="cent">科学课程</td>
                                            <?php else: ?>
                                            <td class="cent">研学</td><?php endif; ?>
                                        <td ><?php echo ($row["goods_title"]); ?></td>
                                        <td class="cent"><?php echo ($row["call_man"]); ?></td>
                                        <td class="cent"><?php echo ($row["tel_num"]); ?></td>
                                        <td class="cent"><?php echo (date('Y-m-d',$row["in_day"])); ?></td>
                                        ...
                                        <td class="cent" width="140" text-align="center">
                                            <a href="<?php echo U('Apply/apply_tra_detail',array('id'=>$row[id],'type'=>$row[type]));?>"><i class="btn btn-upd btn-smsm fa fa-pencil">审核</i></a>
