                                ...
                                <div class="box-body">
                                    <table class="table table-bordered dataTable fontmini" id="tablelist">
                                        ...
                                        <?php if(is_array($datalist)): foreach($datalist as $key=>$row): ?><tr>
											...
											<td style="line-height:36px;"><?php echo ($row["o2o_counter"]); ?></td>
                                            <td style="line-height:36px;"><?php echo ($row["kjlm_counter"]); ?></td>
                                            <td style="line-height:36px;"><?php echo ($row["date"]); ?></td>
