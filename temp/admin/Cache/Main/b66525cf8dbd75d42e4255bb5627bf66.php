    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Goods/index');?>">专家讲座管理</a></li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <?php if(rolemenu('Goods/add')): ?><a href="<?php echo U('Goods/add');?>" style="color:#ffffff;" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 发布文章</a><?php endif; ?>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body" id="piclist">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <?php if(rolemenu('Goods/edit')): ?><th width="60" class="taskOptions">编辑</th><?php endif; ?>
                                ...
                                <?php if(is_array($infolist)): foreach($infolist as $key=>$row): ?><tr>
                                        ...
                                        <td style="line-height:24px;">
                                            <?php echo ($row["pic"]); ?> <a href="" target="_blank"><?php echo ($row["title"]); ?></a>
                                        </td>
                                        <td style="line-height:24px;"><?php echo get_kind($row['col']);?></td>
                                        <td style="line-height:24px;"><?php echo ($row["zhuanjia"]); ?></td>
                                        ...
                                        <?php if(rolemenu('Goods/edit')): ?><td class="taskOptions"  style="line-height:24px;">
                                                <a href="<?php echo U('Goods/edit',array('id'=>$row['id'],'kind'=>$kind));?>" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td><?php endif; ?>
...
<div id="searchtext">
    <form method="get" action="<?php echo U('Goods/index');?>" id="searchfrom" name="myform">
        ...
        <div class="form-group col-md-6">
            <select class="form-control" name="kind">
                ...
                <?php if(is_array($infotype)): foreach($infotype as $k=>$v): ?><option value="<?php echo ($k); ?>"><?php echo ($v); ?></option><?php endforeach; endif; ?>
            </select>
        </div>
