    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Goods/science');?>">发布科学课程产品(表格类)</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                <form method="post" action="<?php echo U('Goods/science_add');?>" name="myform" id="myform">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-warning">
                            <div class="box-header">
                                <h3 class="box-title">发布科学课程产品(表格类)</h3>
                            </div>
                            <div class="box-body" style="padding-top:20px;" id="form_tip">
                                ...
                                <?php echo upload_m('uploadfile','files',$atts,'上传相关图片(第一张默认为标题图片)');?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-success">
                            <div class="box-header">
                                <h3 class="box-title">课程安排</h3>
                            </div>
                            <div class="box-body" style="padding-top:20px;">

                                <div class="form-group col-md-12" id="addti_btn">
                                    <a href="javascript:;" class="btn btn-success btn-sm" onClick="task(1)" style="margin-right:10px;"><i class="fa fa-fw  fa-plus"></i> 添加上学期课程</a>
                                </div>
                                ...
                                <div id="task_timu">
                                    <?php if(is_array($days)): foreach($days as $k=>$v): ?><div class="tasklist" id="task_a_<?php echo ($v["id"]); ?>">
                                            ...
                                            <div class="col-md-12 pd">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" placeholder="课程概要" name="days[<?php echo ($v["id"]); ?>1000][citys]" class="form-control" value="<?php echo ($v["citys"]); ?>">
                                                </div>
                                                <div class="input-group pads">
                                                    <textarea class="form-control" placeholder="课时" name="days[<?php echo ($v["id"]); ?>1000][content]"><?php echo ($v["content"]); ?></textarea>
                                                </div>
                                                <div class="input-group">
                                                    <input type="text" placeholder="课程安排" name="days[<?php echo ($v["id"]); ?>1000][remarks]" class="form-control" value="<?php echo ($v["remarks"]); ?>">
                                                </div>
                                            </div>
                                        </div><?php endforeach; endif; ?>
                                </div>
                                ...
                                <!--<?php echo upload_m('daysfile','daysfiles',$daypic,'&nbsp;理论课程所需材料列表图片','daysbox','daypic','某一天的图片');?>-->
								<div id="daysbox"></div>
                                <div class="form-group">&nbsp;</div>
                            </div>
                            ...
                            <div class="box-body" style="padding-top:20px;">
                                ...
                                <div class="form-group col-md-12" id="addti_btn">
                                    <a href="javascript:;" class="btn btn-success btn-sm" onClick="task_next(1)" style="margin-right:10px;"><i class="fa fa-fw  fa-plus"></i> 添加下学期课程</a>
                                </div>

                                <div id="task_timu_next">
                                    <?php if(is_array($days_next)): foreach($days_next as $key=>$val): ?><div class="tasklist" id="task_b_<?php echo ($val["id"]); ?>">
                                            <a class="au_close" href="javascript:;" onClick="del_timu_next('task_b_<?php echo ($val["id"]); ?>');">×</a>
                                            <div class="col-md-12 pd">
                                                <label class="titou"><strong>第<span class="tihao_next"><?php echo ($key+1); ?></span>天</strong></label>
                                                <div class="input-group">
                                                    <input type="text" placeholder="课程概要" name="days_next[<?php echo ($val["id"]); ?>1000][citys]" class="form-control" value="<?php echo ($val["citys"]); ?>">
                                                </div>
                                                <div class="input-group pads">
                                                    <textarea class="form-control" placeholder="课时" name="days_next[<?php echo ($val["id"]); ?>1000][content]"><?php echo ($val["content"]); ?></textarea>
                                                </div>
                                                <div class="input-group">
                                                    <input type="text" placeholder="课程安排" name="days_next[<?php echo ($val["id"]); ?>1000][remarks]" class="form-control" value="<?php echo ($val["remarks"]); ?>">
                                                </div>
                                            </div>
                                        </div><?php endforeach; endif; ?>
                                </div>

                                <div style="display:none" id="task_val_next">0</div>
                                <div id="daysbox"></div>
...
<script type="text/javascript">
    ...
    function task(obj){
        ...
        /*var days = '<div class="input-group"><input type="text" placeholder="课时" name="days['+i+'][citys]" class="form-control"></div><div class="input-group pads"><textarea class="form-control" placeholder="课程安排"  name="days['+i+'][content]"></textarea></div><div class="input-group"><input type="text" placeholder="房餐车安排" name="days['+i+'][remarks]" class="form-control"></div>';*/
        var days = '<div class="input-group"><input type="text" placeholder="课程概要" name="days['+i+'][citys]" class="form-control"></div><div class="input-group pads"><textarea class="form-control" placeholder="课时"  name="days['+i+'][content]"></textarea></div><div class="input-group"><input type="text" placeholder="课程安排" name="days['+i+'][remarks]" class="form-control"></div>';
    ...
    function task_next(obj){
        ...
        var n = parseInt($('#task_val_next').text())+1;

        var days_next = '<div class="input-group"><input type="text" placeholder="课程概要" name="days_next['+n+'][citys]" class="form-control"></div><div class="input-group pads"><textarea class="form-control" placeholder="课时"  name="days_next['+n+'][content]"></textarea></div><div class="input-group"><input type="text" placeholder="课程安排" name="days_next['+n+'][remarks]" class="form-control"></div>';

        var header_next = '<div class="tasklist" id="task_tb_'+n+'"><a class="au_close" href="javascript:;" onClick="del_timu_next(\'task_tb_'+n+'\')">×</a><div class="col-md-12 pd"><label class="titou"><strong>第<span class="tihao_next">'+n+'</span>天</strong></label>';

        var footer_next = '</div></div>';


        var html = header_next+days_next+footer_next;

        $('#task_timu_next').append(html);
        $('#task_val_next').html(n);
        //重编题号
        $('.tihao_next').each(function(index, element) {
            var no = index*1+1;
            $(this).text(no);
        });
    }
