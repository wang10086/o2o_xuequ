    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Apply/apply_lecture');?>">预约记录列表</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="margin-top:20px;">
                            <form method="post" action="<?php echo U('Apply/Apply_lec_add');?>" name="myform" id="myform" onsubmit="return beforeSubmit(this)">
                                <input type="hidden" name="dosubmint" value="1" />
                                <!-- text input -->
                                <div class="form-group col-md-4">
                                    <label>学校(单位)名称</label>
                                    <input type="text" name="info[unit_name]" value="<?php echo ($row["unit_name"]); ?>"  id="title"  class="form-control" />
                                </div>

                                <div class="form-group col-md-4">
                                    <label>讲课地点</label>
                                    <input type="text" name="info[show_addr]" value="<?php echo ($row["show_addr"]); ?>" class="form-control" />
                                </div>
                                
                                <div class="form-group col-md-4">
                                    <label>联系人姓名</label>
                                    <input type="text" name="info[yq_name]" value="<?php echo ($row["yq_name"]); ?>" class="form-control" />
                                </div>

                                <div class="form-group col-md-4">
                                    <label>联系电话</label>
                                    <input type="text" name="info[tel_num]" value="<?php echo ($row["tel_num"]); ?>" id="tel" class="form-control" />
                                </div>

                                <div class="form-group col-md-4">
                                    <label>电子邮箱(微信)</label>
                                    <input type="text" name="info[e_mail]" value="<?php echo ($row["e_mail"]); ?>" class="form-control" />
                                </div>

                                <div class="form-group col-md-4">
                                    <label>讲课时间</label>
                                    <input type="text" name="info[in_day]" value="<?php echo ($row["in_day"]); ?>" class="inputdate form-control" />
                                </div>

                                <div class="form-group col-md-4">
                                    <label>听课对象</label>
                                    <input type="text" name="info[listener]" value="<?php echo ($row["listener"]); ?>" class="form-control" />
                                </div>

                                <div class="form-group col-md-4">
                                    <label>专家名字</label>
                                    <input type="text" name="zj_name" value="<?php echo ($row["zj_name"]); ?>" onblur="check_zj()" class="form-control" />
                                </div>
...
<script type="text/javascript">
    ...
    function check_zj(){
        ...
        $.ajax({
            type:"POST",
            url :"<?php echo U('Ajax/add_lecture');?>",
            data:{name:name},
