            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('Apply/index');?>">支撑服务校申请记录</a></li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right box-tools">
                                        ...
                                        <?php if(rolemenu('Apply/apply_pro')): ?><a href="<?php echo U('Apply/apply_pro');?>" style="color:#ffffff;" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> 录入学校</a><?php endif; ?>
                                    </div>
                                ...
                                <div class="box-body">
                                    <table class="table table-bordered dataTable fontmini" id="tablelist">
                                    	<tr role="row" class="orders" >
                                            ...
                                            <?php if(rolemenu('Apply/apply_pro')): ?><th class="sorting taskOptions" width="180">操作</th><?php endif; ?>
										</tr>
                                        <?php if(is_array($users)): foreach($users as $key=>$row): ?><tr>
                                            ...
                                            <td><?php echo ($row["contacts_name"]); ?></td>
                                            <td><?php echo ($row["contacts_mobile"]); ?></td>
											<td><?php if($row['apply_time']): echo (date('Y-m-d H:i:s',$row["apply_time"])); endif; ?></td>
                                            
                                            <td><?php echo ($row["strstatus"]); ?></td>
                                            
                                            <?php if(rolemenu('Goods/edit')): ?><td class="taskOptions" >
                                                <?php if($row["status"] == 0): ?><a href="<?php echo U('Apply/apply_pro',array('id'=>$row['id']));?>" title="审核" class="btn btn-upd btn-smsm"><i class="fa fa-pencil"></i>审核</a>
                                                    <?php else: ?>
                                                    <a href="javascript:;" title="审核" class="btn btn-upd btn-smsm" disabled><i class="fa fa-pencil"></i>审核</a><?php endif; ?>

                                                <a href="<?php echo U('Apply/apply_pro_detail',array('id'=>$row['id']));?>" title="详情" class="btn btn-info btn-smsm"><i class="ion-gear-a"></i>详情</a>
                                                <!--<a href="<?php echo U('Apply/apply_pro_del',array('id'=>$row['id']));?>" onclick="return del()" title="删除" class="btn btn-del btn-smsm"><i class="icon ion-close-circled"></i>删除</a>-->
                                            </td><?php endif; ?>
