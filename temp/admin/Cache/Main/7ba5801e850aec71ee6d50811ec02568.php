    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Goods/sci');?>">科技节产品管理</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">科技节产品列表</h3>
                            <div class="pull-right box-tools">

                                <button class="btn btn-info btn-sm" onclick="javascript:opensearch('searchtext',700,100);"><i class="fa fa-search"></i> 搜索</button>
                                <?php if(rolemenu('Goods/sci_add')): ?><a href="<?php echo U('Goods/sci_add');?>" style="color:#ffffff;" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 发布产品</a><?php endif; ?>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body" id="piclist">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <?php if(rolemenu('Goods/sci_edit')): ?><th width="60" class="taskOptions">编辑</th><?php endif; ?>
                                    <?php if(rolemenu('Delete/del_sci')): ?><th width="60" class="taskOptions">删除</th><?php endif; ?>
                                ...
                                <?php if(is_array($infolist)): foreach($infolist as $key=>$row): ?><tr>
                                        ...
                                        <?php if(rolemenu('Goods/sci_edit')): ?><td class="taskOptions"  style="line-height:24px;">
                                                <a href="<?php echo U('Goods/sci_edit',array('id'=>$row['id']));?>" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td><?php endif; ?>
										
                                        <?php if(rolemenu('Goods/del_sci')): ?><td class="taskOptions" style="line-height:24px;">
                                                <a onClick="javascript:ConfirmDel('<?php echo U('Goods/del_sci',array('id'=>$row['id']));?>');" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></a>
                                            </td><?php endif; ?>
...
<div id="searchtext">
    <form method="get" action="<?php echo U('Goods/sci');?>" id="searchfrom" name="myform">
        <input type="hidden" name="m" value="Main">
        <input type="hidden" name="c" value="Goods">
        <input type="hidden" name="a" value="sci">
