    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Apply/apply_service');?>">老专家演讲预约记录</a></li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <?php if(rolemenu('Apply/apply_lec_add')): ?><a href="<?php echo U('Apply/apply_lec_add');?>" style="color:#ffffff;" class="btn btn-success  btn-sm"><i class="fa fa-plus"></i> 录入预约信息</a><?php endif; ?>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$row): ?><tr>
                                        ...
                                        <td><?php echo ($row["call_man"]); ?></td>
                                        <td><?php echo ($row["tel_num"]); ?></td>
                                        <td><?php echo ($row["yq_name"]); ?></td>
                                        <td><?php echo ($row["listener"]); ?></td>
                                        <td><?php echo ($row["in_day"]); ?></td>
                                        <td><?php if($row['booking_time']): echo (date('Y-m-d H:i:s',$row["booking_time"])); endif; ?></td>
                                        <td><?php echo ($row["strstatus"]); ?></td>
                                        <td class="taskOptions">
                                            <a href="<?php echo U('Apply/apply_lecture_detail',array('id' =>$row['id'],'type'=>$row['type']));?>"><i class="btn btn-upd btn-smsm fa fa-pencil">审核</i></a>
