                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="margin-top:20px;">
                            <form method="post" action="<?php echo U('Goods/product_edit');?>" name="myform" id="myform">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="info[sort]" id="sort" value="<?php echo ($row["sort"]); ?>" class="form-control" />
                                </div>
                                
                                <div class="form-group col-md-4">
                                    <label>参考价格</label>
                                    <input type="text" name="info[price]" id="price" value="<?php echo ($row["price"]); ?>"  class="form-control" />
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label>课程特色</label>
                                    <textarea class="form-control" name="info[lights]" style="height:120px" ><?php echo ($row["lights"]); ?></textarea>
                                </div>
