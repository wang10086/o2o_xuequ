                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <button onClick="javascript:window.location.href='<?php echo U('Goods/goods_add');?>';" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 新增项目</button>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <?php if(rolemenu(array('Goods/goods_add'))): ?><th width="60" class="taskOptions">编辑</th><?php endif; ?>
                                    <?php if(rolemenu(array('Goods/del_goods'))): ?><th width="60" class="taskOptions">删除</th><?php endif; ?>
                                </tr>
                                <?php if(is_array($datalist)): foreach($datalist as $key=>$row): ?><tr>
                                        ...
                                        <?php if(rolemenu(array('Goods/goods_add'))): ?><td class="taskOptions">
                                                <a href="<?php echo U('Goods/goods_add',array('id'=>$row['id']));?>" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td><?php endif; ?>
                                        <?php if(rolemenu(array('Goods/del_goods'))): ?><td class="taskOptions">
                                                <a href="JavaScript:;"  onClick="javascript:ConfirmDel('<?php echo U('Goods/del_goods',array('id'=>$row['id']));?>');" title="删除" class="btn btn-danger btn-smsm"><i class="fa fa-times"></i></a>
                                            </td><?php endif; ?>
