    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Goods/goodslist');?>">科学课程产品(表格类)列表</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">科学课程产品(表格类)列表</h3>
                            <div class="pull-right box-tools">
                                <button class="btn btn-info btn-sm" onclick="javascript:opensearch('searchtext',500,160);"><i class="fa fa-search"></i> 搜索</button>
                                <button onClick="javascript:window.location.href='<?php echo U('Goods/science_add');?>';" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 新增科学课程产品(表格类)列表</button>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <?php if(rolemenu(array('Goods/science_add'))): ?><th width="60" class="taskOptions">编辑</th><?php endif; ?>
                                    <?php if(rolemenu(array('Goods/del_science'))): ?><th width="60" class="taskOptions">删除</th><?php endif; ?>
                                </tr>
                                <?php if(is_array($datalist)): foreach($datalist as $key=>$row): ?><tr>
                                        ...
                                        <td><?php if($row['create_time']): echo (date('y-m-d H:i',$row["create_time"])); endif; ?></td>
                                        <td><?php if($row['update_time']): echo (date('y-m-d H:i',$row["update_time"])); endif; ?></td>
                                        <?php if(rolemenu(array('Goods/science_add'))): ?><td class="taskOptions">
                                                <a href="<?php echo U('Goods/science_add',array('id'=>$row['id']));?>" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td><?php endif; ?>
                                        <?php if(rolemenu(array('Goods/del_science'))): ?><td class="taskOptions">
                                                <a href="JavaScript:;"  onClick="javascript:ConfirmDel('<?php echo U('Goods/del_science',array('id'=>$row['id']));?>');" title="删除" class="btn btn-danger btn-smsm"><i class="fa fa-times"></i></a>
                                            </td><?php endif; ?>
    ...
    <form action="" method="get" id="searchform">
        ...
        <div class="form-group col-md-5">
            <select  class="form-control"  name="kind">
                ...
                <?php if(is_array($kindlist)): foreach($kindlist as $k=>$v): ?><option value="<?php echo ($k); ?>"><?php echo ($v); ?></option><?php endforeach; endif; ?>
            </select>
        </div>
