...
<aside class="left-side sidebar-offcanvas" id="indexmenus">
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            <h1>发布<?php echo ($kindname); ?></h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo U('Index/index');?>"><i class="fa fa-home"></i> 首页</a></li>
                <li><a href="<?php echo U('News/travel',array('kind'=>$kind));?>">旅游文章列表</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="margin-top:20px;">
                            <form method="post" action="<?php echo U('News/tra_add');?>" name="myform" id="myform">
                                ...
                                <div class="form-group col-md-4">
                                    <label>发布者</label>
                                    <input type="text" name="info[editor]" id="editor" value="<?php echo cookie('name');?>"  class="form-control" />
                                </div>
                                <div class="form-group col-md-4">
                                    <label>文章来源</label>
                                ...
                                <div class="form-group col-md-12">
                                    <label>标题</label>
                                    <input type="text" name="info[title]" id="title" value="<?php echo ($row["title"]); ?>"  class="form-control" />
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="info[keywords]" id="keywords" value="<?php echo ($row["keywords"]); ?>" class="form-control" />
                                </div>
                                <div class="form-group col-md-12">
                                    <label>描述</label>
                                ...
                                <?php echo upload_m('uploadfile','files',$pic,'上传标题图片');?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box box-success">
                                        ...
                                        <div class="box-body" style="padding-top:20px;">
                                                ...
                                                <?php if(is_array($days)): foreach($days as $k=>$v): ?><div class="tasklist" id="task_a_<?php echo ($v["id"]); ?>">
                                                        ...
                                                        <div class="col-md-12 pd">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" placeholder="活动小标题" name="days[<?php echo ($v["id"]); ?>1000][remarks]" class="form-control" value="<?php echo ($v["remarks"]); ?>">
                                                            </div>
                                                            ...
                                                            <div class="input-group pads">
                                                                <textarea class="form-control" placeholder="行程内容" name="days[<?php echo ($v["id"]); ?>1000][content]"><?php echo ($v["content"]); ?></textarea>
                                                            </div>
                                                        </div>
                                            ...
                                            <?php echo upload_m('daysfile','daysfiles',$atts,'&nbsp;日程照片','daysbox','daypic','某一天的图片');?>
                                            <div id="daysbox"></div>
