    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Apply/apply_tra');?>">申请记录</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                ...
                <!-- right column -->
                <form method="post" action="<?php echo U('Apply/apply_tra_detail');?>" name="myform" id="myform" >
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="padding-top:0 20px;" id="form_tip">
							...
							<div class="form-group" style="padding:20px;">
                                ...
                                <?php if($data[type] == 1): ?><label  class="biaoti">科学课程名称：<?php echo ($data["goods_title"]); ?></label>
                                    <?php else: ?>
                                    <label  class="biaoti">研学旅行名称：<?php echo ($data["goods_title"]); ?></label><?php endif; ?>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="col-sm-4 control-label">预约类型</label>
                                <div class="col-sm-8">
                                    <?php if($data[type] == 1): ?><input type="text" class="form-control noinput" value="科学课程" readonly  />
                                        <?php else: ?>
                                        <input type="text" class="form-control noinput" value="研学旅行" readonly  /><?php endif; ?>
