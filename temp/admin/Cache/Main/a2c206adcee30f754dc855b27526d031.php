    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Apply/apply_sci');?>">申请记录</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                ...
                <!-- right column -->
                <form method="post" action="<?php echo U('Apply/apply_sci_detail');?>" name="myform" id="myform" >
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="padding-top:0 20px;" id="form_tip">
							...
							<div class="form-group" style="padding:20px;">
                                <label  class="biaoti">科技节名称：<?php echo ($data["title"]); ?></label>
                            </div>
                            <div class="form-group col-md-8">
                                <label class="col-sm-4 control-label">科技节名称</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control noinput" value="<?php echo ($data['title']); ?>" readonly  />
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="col-sm-4 control-label">邀请单位</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control noinput" value="<?php echo ($data["school_name"]); ?>" readonly />
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control noinput" value="<?php echo (date('Y-m-d',$data["in_day"])); ?>" readonly />
                                </div>
                            </div>
