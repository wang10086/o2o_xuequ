    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Res/index');?>">资源管理</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="margin-top:20px;">
                            <form method="post" action="<?php echo U('Res/res_edit');?>" name="myform" id="myform">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="info[cms_exp_id]" value="<?php echo ($row["cms_exp_id"]); ?>" class="form-control" />
                                </div>

                                <div class="form-group col-md-4">
                                    <label>资源类型</label>
                                    <select class="form-control" name="info[type]">
                                        <?php if(is_array($kind)): foreach($kind as $k=>$v): ?><option value="<?php echo ($k); ?>" <?php if($type==$k || $row['type']==$k){ echo 'selected';} ?> ><?php echo ($v); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control"  name="info[fields]">
                                        ...
                                        <?php if(is_array($resf)): foreach($resf as $key=>$v): ?><option value="<?php echo ($v); ?>" <?php if($row['fields']==$v){ echo 'selected';} ?>><?php echo ($v); ?></option><?php endforeach; endif; ?>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="info[system]" class="form-control"   >
                                        <option value="">请选择</option>
                                        <?php if(is_array($ress)): foreach($ress as $key=>$v): ?><option value="<?php echo ($v); ?>" <?php if($row['system']==$v){ echo 'selected';} ?>><?php echo ($v); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>

                                <div class="form-group col-md-4">
                                    <label>所在地区</label>
                                    <input type="text" name="info[city]" value="<?php echo ($row["city"]); ?>"  id="city" class="form-control" />
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    <label>实施城市</label>
                                    <input type="text" name="info[ss_city]" value="<?php echo ($row["ss_city"]); ?>"  id="ss_city" class="form-control" />
                                </div>

                                
                                <div class="form-group col-md-12">
                                	<span class="lm_c"><strong>支持项目</strong></span>
                                    <?php if(is_array($resp)): foreach($resp as $k=>$v): ?><span class="lm_c"><input type="checkbox" name="pro[]" <?php if(in_array($v,$pro)){ echo 'checked';} ?>  value="<?php echo ($v); ?>"> <?php echo ($v); ?></span><?php endforeach; endif; ?>
                                </div>
                                ...
                                <?php echo upload_m('uploadfile','files',$atts,'资源照片');?>
                                ...
                                <!--<div class="form-group col-md-12" style="margin-top:15px;">
                                    <label>内容</label>
                                    <textarea name="info[content]"  rows="10" class="form-control" value="<?php echo ($row["content"]); ?>"><?php echo ($row["content"]); ?></textarea>
                                </div>-->
