...
<div class="unbox">
    <div class="content ovhid">
        ...
        <div class="crumbs">
            您所在的位置：<a href="<?php echo U('Index/home');?>">首页</a>  <span>&gt;</span> <a href="<?php echo U('Gongyi/gongyi');?>">科教公益项目</a><span>&gt;</span> <a href="#">预约公益项目</a>
        </div>
        
        <h1 id="title" style="font-size:26px; font-weight:200;">中科筑梦行动——科学家讲堂公益项目申请表</h1>

            <form class="applyform" action="<?php echo U('Gongyi/pubLession');?>">
            ...
            <div class="unfrom gbg">
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" name="info[school_name]" placeholder="请输入学校(单位)名称" datatype="s4-20" nullmsg="请输入学校(单位)名称！" value="<?php echo ($row["school_name"]); ?>" class="fromval" >
                    ...
                    <li>
                        ...
                        <input type="text" name="info[school_addr]"  value="<?php echo ($row["school_addr"]); ?>"  placeholder="请输入学校(单位)地址"  datatype="s4-30" nullmsg="请输入学校(单位)地址！" class="fromval" >
                        <span class="Validform_checktip"></span>
                    </li>
                </ul>
            </div>
            <div class="unfrom">
                ...
                <ul>
                    ...
                    <li>
                        <label>办公电话</label>
                        <input type="text" name="info[tel_num]" value="<?php echo ($row["tel_num"]); ?>" placeholder="请输入办公电话" datatype="/^[^\D]{11,12}$/" nullmsg="请输入负责人办公电话！" class="fromval" >
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                        <label>手机</label>
            ...
            <div class="unfrom gbg">
                ...
                <ul>
                    ...
                    <li>
                        <label>办公电话</label>
                        <input type="text" name="info[contacts_tel]" value="<?php echo ($row["contacts_tel"]); ?>" placeholder="请输入办公电话" datatype="/^[^\D]{11,12}$/" nullmsg="请输入联系人办公电话！" class="fromval" >
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                        <label>手机</label>
                ...
                <ul>
                    <li>
                        ...
                        <select name="data[res_id]" class="fromval" onchange="check_res()" id="res_id"  datatype="s1-10" nullmsg="请选择专家" errormsg="请选择专家">
                            ...
                            <?php if(is_array($res)): foreach($res as $k=>$v): ?><option value="<?php echo ($k); ?>" <?php if($row['res_id']==$k){ echo 'selected';} ?>><?php echo ($v); ?></option><?php endforeach; endif; ?>
                        </select>
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                    ...
                    <li>
                        <label>讲课地点</label>
                        <input type="text" name="data[show_addr]" datatype="s2-30" nullmsg="请输入讲课地点" errormsg="请输入2-30位字符" value="<?php echo ($info['school_addr']); ?>" placeholder="请输入讲课地点">
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                        <label>听课对象</label>
            ...
            <div class="unfrom" style="padding-top: 0px">
                ...
                <textarea name="info[description]" class="fromval"  required><?php echo ($row["description"]); ?></textarea>
		...
		$(".applyform").Validform({
			...
			callback:function(data){
				...
				if(obj.status == 'y'){
					...
					setTimeout("window.location.href='<?php echo U('Gongyi/gongyi');?>'",3000);
				}else{
					showmsg('提示',data.info); 
				}
			}
