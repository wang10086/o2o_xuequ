...
<div class="unbox">
    <div class="content ovhid">
        ...
        <div class="crumbs">
            您所在的位置：<a href="<?php echo U('Index/home');?>">首页</a>  <span>&gt;</span> <a href="#">修改密码</a>
        </div>

        <h1 id="title" style="font-size:26px; font-weight:200;">修改密码</h1>

        <form class="applyform registerform" method="post" action="<?php echo U('Login/reset_pwd');?>">
            ...
            <div class="loginfrom gbg">
                <ul>
                    <li>
                        <label>用户名</label>
                        <input type="text" class="text" name="info[username]" value="<?php echo ($username); ?>"  readonly />
                        <!--<input type="text" class="text" name="info[username]" placeholder="请输入用户名" datatype="*2-16" nullmsg="请输入用户名！" >
                        <span class="Validform_checktip"></span>-->
                    </li>
                    <li>
                        <label>手机号</label>
                        <input type="text" class="text mobile-input" id="mobile" name="info[mobile]" value="<?php echo ($mobile); ?>" readonly />
                        <!--<input type="text" class="text mobile-input" id="mobile" name="info[mobile]" value="{mobile}" placeholder="请输入手机号" datatype="m" nullmsg="手机号格式不正确！" errormsg="手机号格式不正确" />
                        <span class="Validform_checktip"></span>-->
                    </li>
                    <li  class="need">
                        <label>密码</label>
            ...
            <div class="unfrom">
                <a href="javascript:;" class="submint disabled-btn">确认更改</a>
            </div>
