...
<div class="unbox mt10">
    <div class="content">
        <div class="crumbs">
            您所在的位置：<a href="<?php echo U('Index/home');?>">首页</a>  <span>&gt;</span> <a href="#">支撑服务校(单位)动态</a>
        </div>
        ...
        <div class="content">
            ...
            <div class="artdetail">
                ...
                <div class="newscon mt20 news_con">
                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="news_list"><div class="news_title"><a href="<?php echo U('Show/kejiao',array('id'=>$vo['id'],'module'=>$vo['module']));?>"><?php echo ($vo["title"]); ?></a></div><span class="news_data"><?php echo (date('Y-m-d',$vo["create_time"])); ?></span></div><?php endforeach; endif; ?>
                </div>
