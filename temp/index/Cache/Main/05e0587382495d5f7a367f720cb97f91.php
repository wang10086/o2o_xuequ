...
<div class="unbox">
    <div class="content">
        ...
        <div class="crumbs">
            您所在的位置：<a href="<?php echo U('Index/home');?>">首页</a>  <span>&gt;</span> <a href="<?php echo U('Gongyi/gongyi');?>">科教公益项目</a>  <span>&gt;</span> <a href="javascript:;">中科创客营</a>
        </div>
        ...
        <div class="content">
            ...
            <div class="artdetail">
                ...
                <div class="threepic mt20">
                    <ul>
                        <li><img src="/index/assets/images/zk_cky.png"><span style="line-height: inherit;padding-top: 10px;">2017年创客运动会中国科学院大学怀柔校区现场</span></li>
                    </ul>
                </div>
