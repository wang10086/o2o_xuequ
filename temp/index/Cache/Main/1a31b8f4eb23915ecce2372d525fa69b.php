...
<div class="unbox">
    <div class="content ovhid">
        ...
        <div class="crumbs">
            您所在的位置：<a href="<?php echo U('Index/home');?>">首页</a>  <span>&gt;</span> <a href="#">找回密码</a>
        </div>

        <h1 id="title" style="font-size:26px; font-weight:200;">找回密码</h1>

        <form class="applyform" method="post" action="<?php echo U('Login/check_mcode');?>">
    ...
    $("#mobile").blur(function(){
       var mobile = $('#mobile').val();
        if(mobile){
            $.ajax({
                type:'post',
                url:"<?php echo U('Login/check_mobile');?>",
                dataType:'json',
                data:{mobile:mobile},
