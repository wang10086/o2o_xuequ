    	...
    	<div class="content">
            ...
            <div class="content mt20 pb20 lx_cont">
                ...
                <?php if(($cities != null) or ($cities != '')): ?><div class="booking_gy">
                        <?php if($kind == 33): ?><div class="lx_gy">课程概要 &nbsp;:&nbsp; </div>
                            <?php else: ?>
                            <div class="lx_gy">行程概要 &nbsp;:&nbsp; </div><?php endif; ?>
                        <?php if(is_array($days)): foreach($days as $k=>$v): ?><div class="lx_day"><span>D<?php echo ($k+1); ?> </span><span class="lx_detail"><?php echo ($v["citys"]); ?></span></div><?php endforeach; endif; ?>
                    </div><?php endif; ?>
                ...
                <?php if(($light != null) or ($light != '')): ?><div class="fill">
                        ...
                        <div class="hl_content">
                            <?php if(is_array($row['lights'])): foreach($row['lights'] as $key=>$v): if($v != null): ?><p>★<?php echo ($v); ?></p><?php endif; endforeach; endif; ?>
                        </div>
                    </div><?php endif; ?>
                </div>
            </div>
            ...
            <div class="lxnrz">
                ...
                <div class="lxunit" id="kechenganpai">
                    ...
                    <?php if(is_array($days)): foreach($days as $k=>$v): ?><div class="dayunit mt40">
                            <div class="day_con">
                                <div class="icon"><?php echo ($k+1); ?></div>
                                <h4><?php echo ($v["citys"]); ?></h4>
                                <p><?php echo nl2br($v['content']);?></p>
                                <p><?php echo nl2br($v['remarks']);?></p>
                            </div>
                            <?php if($v['filepath']): ?><img src="/<?php echo ($v['filepath']); ?>"><?php endif; ?>
                ...
                <?php if($row['security']): ?><div class="lxunit" id="anquanbaozhang">
                        ...
                        <div class="conts">
                            <p><?php echo nl2br($row['security']);?></p>
                        </div>
                    </div><?php endif; ?>
            </div>
        </div>
