...
<div class="unbox">
    <div class="content ovhid">
        ...
        <div class="crumbs">
            您所在的位置：<a href="<?php echo U('Index/home');?>">首页</a>  <span>&gt;</span> <a href="<?php echo U('Pro/index',array('kind'=>33));?>">科学课程</a><span>&gt;</span> <a href="#">预约</a>
        </div>
        
        <h1 id="title" style="font-size:26px; font-weight:200;"><?php echo ($data["title"]); ?></h1>
        
        <form class="applyform" action="<?php echo U('Member/apply_science');?>">
        	<input type="hidden" name="info[goods_id]" value="<?php echo ($data["id"]); ?>">
            <input type="hidden" name="info[pic]" value="<?php echo ($data["pic"]); ?>">
            ...
            <div class="unfrom gbg">
                ...
                <ul>
                    ...
                    <li>
                        <label>预约课程名称</label>
                        <input type="text" name="info[title]" value="<?php echo ($data['title']); ?>" readonly>
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                        <label>活动对象</label>
                        <input type="text" name="info[listener]" datatype="s2-30" nullmsg="请输入活动对象" errormsg="请输入2-30位字符" placeholder="请输入活动参与对象">
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                        <label>讲课时间</label>
                        <input type="text" name="info[in_day]" class="inputdate" placeholder="请选择讲课时间"  datatype="*6-30" value="<?php echo ($date); ?>" nullmsg="请选择讲课时间！">
                        <span class="Validform_checktip"></span>
                    </li>
