...
<div class="unbox">
    <div class="content">
        ...
        <div class="crumbs">
            您所在的位置：<a href="<?php echo U('Index/home');?>">首页</a>  <span>&gt;</span> <a href="#">高端科教资源</a>
        </div>
        ...
        <div class="content mt20">
            <div class="menu">
                ...
                <?php if(is_array($dataA)): foreach($dataA as $key=>$vo): ?><div class="unit">
                        <a href="<?php echo U('Resource/index',array('type'=>$vo['id']));?>"><h3><?php echo ($vo["title"]); ?></h3></a>
                        <div class="morebox">
                            <ul>
                                <?php if(is_array($dataB)): foreach($dataB as $key=>$v): if($v['pid'] == $vo['id']): ?><li><a href="<?php echo U('Resource/index',array('type'=>$v['id']));?>"><?php echo ($v["title"]); ?></a></li><?php endif; endforeach; endif; ?>
                            </ul>
            ...
            <div class="prolist">
				<form method="get" action="<?php echo U('Resource/index');?>" name="myform">
                ...
                <div class="jiansuo">
                    ...
                    <select name="city">
                        <option value="">请选择</option>
                        <?php if(is_array($resc)): foreach($resc as $key=>$v): ?><option value="<?php echo ($v); ?>" <?php if($city==$v){ echo 'selected';} ?>><?php echo ($v); ?></option><?php endforeach; endif; ?>
                    </select>
                    &nbsp;
                    <span>所属系统：</span>
                    <select name="sys">
                        <option value="">请选择</option>
                        <?php if(is_array($ress)): foreach($ress as $key=>$v): ?><option value="<?php echo ($v); ?>" <?php if($sys==$v){ echo 'selected';} ?>><?php echo ($v); ?></option><?php endforeach; endif; ?>
                    </select>
                    &nbsp;
                    <span>支持项目：</span>
                    <select name="pro">
                        <option value="">请选择</option>
                        <?php if(is_array($resp)): foreach($resp as $key=>$v): ?><option value="<?php echo ($v); ?>" <?php if($pro==$v){ echo 'selected';} ?>><?php echo ($v); ?></option><?php endforeach; endif; ?>
                    </select>
                    &nbsp;
                    <input type="text" class="inputtext" name="kw" value="<?php echo ($kw); ?>">
                    <button>GO</button>
                </div>
                </form>
                    ...
                    <div class="plist">
                        <ul>
                            <?php if(is_array($datalist)): foreach($datalist as $key=>$vo): ?><li>
                                    <input type="hidden" name="col" value="<?php echo ($vo["col"]); ?>">
                                    <?php if($vo['type'] == '2'): ?><h2><a href="<?php echo U('Resource/ziyuan_morepic_detail',array('id'=>$vo['id'],'type'=>$vo['type'],'col'=>$vo['col']));?>"><?php echo ($vo["title"]); ?></a></h2>
                                        <a href="<?php echo U('Resource/ziyuan_morepic_detail',array('id'=>$vo['id'],'type'=>$vo['type'],'col'=>$vo['col']));?>"><img src="/<?php echo ($vo["pic"]); ?>"></a>
                                        <div>
                                            <p>科教领域 : <?php echo ($vo["fields"]); ?></p>
                                            <p>所在省市 : <?php echo ($vo["city"]); ?></p>
                                            <p>支持项目 : <?php echo ($vo["pro"]); ?></p>
                                            <a href="<?php echo U('Resource/ziyuan_morepic_detail',array('id'=>$vo['id'],'type'=>$vo['type'],'col'=>$vo['col']));?>" class="more">了解详情</a>
                                        </div>
                                    <?php else: ?>
                                        <h2><a href="<?php echo U('Resource/ziyuan_detail',array('id'=>$vo['id'],'type'=>$vo['type']));?>"><?php echo ($vo["title"]); ?></a></h2>
                                        <a href="<?php echo U('Resource/ziyuan_detail',array('id'=>$vo['id'],'type'=>$vo['type']));?>"><img src="/<?php echo ($vo["pic"]); ?>"></a>
                                        <div>
                                            <p>科教领域 : <?php echo ($vo["fields"]); ?></p>
                                            <p>所在省市 : <?php echo ($vo["city"]); ?></p>
                                            <p>支持项目 : <?php echo ($vo["pro"]); ?></p>
                                            <a href="<?php echo U('Resource/ziyuan_detail',array('id'=>$vo['id'],'col'=>$vo['col']));?>" class="more">了解详情</a>
                                        </div><?php endif; ?>
