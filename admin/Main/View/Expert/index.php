    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{:U('Expert/index',array('type'=>$type))}">{$pagename}管理</a></li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <if condition="rolemenu('Expert/add')">
                                    <a href="{:U('Expert/add',array('kind'=>$kind))}" style="color:#ffffff;" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 发布文章</a>
                                </if>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body" id="piclist">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <if condition="rolemenu('Expert/edit')">
                                ...
                                <foreach name="infolist" item="row">
                                    <tr>
                                        ...
                                        <td style="line-height:24px;">
                                            ...
                                            if($kind==1){
                                                $url = $con['__HTTP_URL__'].'index.php?m=Main&c=Expert&a=detail&id='.$row['id'];
                                            }else if($kind==2){
                                        ...
                                        <td style="line-height:24px;">{$row.source}</td>
                                        ...
                                        <if condition="rolemenu('Expert/edit')">
                                            <td class="taskOptions"  style="line-height:24px;">
                                                <a href="{:U('Expert/edit',array('id'=>$row['id'],'kind'=>$kind))}" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </if>

                                        <if condition="rolemenu('Expert/del_news')">
                                            <td class="taskOptions" style="line-height:24px;">
                                                <a onClick="javascript:ConfirmDel('{:U('Expert/del_news',array('id'=>$row['id']))}');" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></a>
                                            </td>
                                        </if>
...
<div id="searchtext">
    <form method="get" action="{:U('Expert/index')}" id="searchfrom" name="myform">
