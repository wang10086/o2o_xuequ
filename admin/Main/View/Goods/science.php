    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{:U('Goods/goodslist')}">科学课程产品(表格类)列表</a></li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <button onClick="javascript:window.location.href='{:U('Goods/science_add')}';" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 新增科学课程产品(表格类)列表</button>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <if condition="rolemenu(array('Goods/science_add'))">
                                        <th width="60" class="taskOptions">编辑</th>
                                    </if>
                                    <if condition="rolemenu(array('Goods/del_science'))">
                                    ...
                                    <tr>
                                        ...
                                        <if condition="rolemenu(array('Goods/science_add'))">
                                            <td class="taskOptions">
                                                <a href="{:U('Goods/science_add',array('id'=>$row['id']))}" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </if>
                                        <if condition="rolemenu(array('Goods/del_science'))">
                                            <td class="taskOptions">
                                                <a href="JavaScript:;"  onClick="javascript:ConfirmDel('{:U('Goods/del_science',array('id'=>$row['id']))}');" title="删除" class="btn btn-danger btn-smsm"><i class="fa fa-times"></i></a>
                                            </td>
                                        </if>
                                    </tr>
                                </foreach>
