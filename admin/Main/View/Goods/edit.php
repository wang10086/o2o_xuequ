    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{:U('Goods/index')}">专家讲座列表</a></li>
            </ol>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <form method="post" action="{:U('Goods/edit')}" name="myform" id="myform">
                        ...
                        <div class="box-body" style="margin-top:20px;">
                            ...
                            <div class="form-group col-md-3">
                                <label>科教专家</label>
                                <input type="text" name="resname" value="{$resname}" class="form-control keywords"/>
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                <label>自定义标签</label>
                                <input type="text" name="info[showtag]" value="{$row.showtag}"  class="form-control" />
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <label>描述</label>
                                <textarea name="info[description]" class="form-control" value="{$row.description}">{$row.description}</textarea>
                            </div>
