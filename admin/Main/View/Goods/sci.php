    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{:U('Goods/sci')}">科技节产品管理</a></li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <if condition="rolemenu('Goods/sci_add')">
                                    <a href="{:U('Goods/sci_add')}" style="color:#ffffff;" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 发布产品</a>
                                </if>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body" id="piclist">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <if condition="rolemenu('Goods/sci_edit')">
                                        <th width="60" class="taskOptions">编辑</th>
                                    </if>
                                    <if condition="rolemenu('Delete/del_sci')">
                                    ...
                                    <tr>
                                        ...
                                        <if condition="rolemenu('Goods/sci_edit')">
                                            <td class="taskOptions"  style="line-height:24px;">
                                                <a href="{:U('Goods/sci_edit',array('id'=>$row['id']))}" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </if>
										
                                        <if condition="rolemenu('Goods/del_sci')">
                                            <td class="taskOptions" style="line-height:24px;">
                                                <a onClick="javascript:ConfirmDel('{:U('Goods/del_sci',array('id'=>$row['id']))}');" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></a>
                                            </td>
                                        </if>
...
<div id="searchtext">
    <form method="get" action="{:U('Goods/sci')}" id="searchfrom" name="myform">
