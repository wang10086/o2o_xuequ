    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{:U('Goods/science')}">发布科学课程产品(表格类)</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                <form method="post" action="{:U('Goods/science_add')}" name="myform" id="myform">
                    <input type="hidden" name="dosubmint" value="1" />
                    <input type="hidden" name="editid" value="{$row.id}" />
                    <input type="hidden" name="info[module]" value="{$module}" />
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body" style="padding-top:20px;" id="form_tip">
                                ...
                                {:upload_m('uploadfile','files',$atts,'上传相关图片(第一张默认为标题图片)')}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body" style="padding-top:20px;">
                                    ...
                                    <foreach name="days" key="k" item="v">
                                        <div class="tasklist" id="task_a_{$v.id}">
                                            ...
                                            <div class="col-md-12 pd">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" placeholder="课程概要" name="days[{$v.id}1000][citys]" class="form-control" value="{$v.citys}">
                                                </div>
                                                <div class="input-group pads">
                                                    <textarea class="form-control" placeholder="课时" name="days[{$v.id}1000][content]">{$v.content}</textarea>
                                                </div>
                                                <div class="input-group">
                                                    <input type="text" placeholder="课程安排" name="days[{$v.id}1000][remarks]" class="form-control" value="{$v.remarks}">
                                                </div>
                                            </div>
                                        </div>
                                    </foreach>
                                ...
                                <!--{:upload_m('daysfile','daysfiles',$daypic,'&nbsp;理论课程所需材料列表图片','daysbox','daypic','某一天的图片')}-->
								<div id="daysbox"></div>
                                <div class="form-group">&nbsp;</div>
                            </div>
                            ...
                            <div class="box-body" style="padding-top:20px;">
                                ...
                                <div id="task_timu_next">
                                    <foreach name="days_next" key="key" item="val">
                                        <div class="tasklist" id="task_b_{$val.id}">
                                            <a class="au_close" href="javascript:;" onClick="del_timu_next('task_b_{$val.id}');">×</a>
                                            <div class="col-md-12 pd">
                                                <label class="titou"><strong>第<span class="tihao_next">{$key+1}</span>天</strong></label>
                                                <div class="input-group">
                                                    <input type="text" placeholder="课程概要" name="days_next[{$val.id}1000][citys]" class="form-control" value="{$val.citys}">
                                                </div>
                                                <div class="input-group pads">
                                                    <textarea class="form-control" placeholder="课时" name="days_next[{$val.id}1000][content]">{$val.content}</textarea>
                                                </div>
                                                <div class="input-group">
                                                    <input type="text" placeholder="课程安排" name="days_next[{$val.id}1000][remarks]" class="form-control" value="{$val.remarks}">
                                                </div>
                                            </div>
                                        </div>
                                    </foreach>
