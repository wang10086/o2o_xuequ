                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="margin-top:20px;">
                            <form method="post" action="{:U('Goods/product_edit')}" name="myform" id="myform">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="info[sort]" id="sort" value="{$row.sort}" class="form-control" />
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label>课程特色</label>
                                    <textarea class="form-control" name="info[lights]" style="height:120px" >{$row.lights}</textarea>
                                </div>
