                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <if condition="rolemenu('Union/morepic_add')">
                                    <a href="{:U('Union/morepic_add',array('kind'=>$kind))}" style="color:#ffffff;" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 发布文章</a>
                                </if>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body" id="piclist">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <if condition="rolemenu('Union/morepic_edit')">
                                ...
                                <foreach name="infolist" item="row">
                                    <tr>
                                        ...
                                        <if condition="rolemenu('Union/morepic_edit')">
                                            <td class="taskOptions"  style="line-height:24px;">
                                                <a href="{:U('Union/morepic_edit',array('id'=>$row['id'],'kind'=>$kind))}" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </if>

                                        <if condition="rolemenu('Union/del_news')">
                                            <td class="taskOptions" style="line-height:24px;">
                                                <a onClick="javascript:ConfirmDel('{:U('Union/del_news',array('id'=>$row['id']))}');" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></a>
                                            </td>
                                        </if>
...
<div id="searchtext">
    <form method="get" action="{:U('Union/index')}" id="searchfrom" name="myform">
