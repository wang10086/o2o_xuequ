    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{:U('Union/morepic_list',array('kind'=>$kind))}">联盟文章(多图)列表</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="margin-top:20px;">
                            <form method="post" action="{:U('Union/morepic_edit')}" name="myform" id="myform">
                                                ...
                                                <foreach name="days" key="k" item="v">
                                                    <div class="tasklist" id="task_a_{$v.id}">
                                                        ...
                                                        <div class="col-md-12 pd">
                                                            ...
                                                            <div class="input-group pads">
                                                                <textarea class="form-control" placeholder="文章内容" name="days[{$v.id}1000][content]">{$v.content}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </foreach>
...
<script type="text/javascript">
    ...
    function task(obj){
        ...
        var days = '<div class="input-group"><input type="text" placeholder="活动小标题" name="days['+i+'][remarks]" class="form-control"></div><div class="input-group pads"><textarea class="form-control" placeholder="文章内容"  name="days['+i+'][content]"></textarea></div>';
