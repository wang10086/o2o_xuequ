    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{:U('News/pic_index',array('type'=>$type))}">{$pagename}管理</a></li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <if condition="rolemenu('News/pic_add')">
                                    <a href="{:U('News/pic_add',array('kind'=>$kind))}" style="color:#ffffff;" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 发布文章</a>
                                </if>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body" id="piclist">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <if condition="rolemenu('News/pic_edit')">
                                        <th width="60" class="taskOptions">编辑</th>
                                    </if>
                                    <?php if($type==1){ ?>
                                        <if condition="rolemenu('Delete/del_pic_news')">
                                ...
                                <foreach name="infolist" item="row">
                                    <tr>
                                        ...
                                        <if condition="rolemenu('News/pic_edit')">
                                            <td class="taskOptions"  style="line-height:24px;">
                                                <a href="{:U('News/pic_edit',array('id'=>$row['id'],'kind'=>$kind))}" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </if>

                                        <if condition="rolemenu('News/del_pic_news')">
                                            <td class="taskOptions" style="line-height:24px;">
                                                <a onClick="javascript:ConfirmDel('{:U('News/del_pic_news',array('id'=>$row['id']))}');" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></a>
                                            </td>
                                        </if>
