                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <if condition="rolemenu('News/tra_add')">
                                    <a href="{:U('News/tra_add',array('kind'=>$kind))}" style="color:#ffffff;" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 发布文章</a>
                                </if>
                            </div>
                        </div><!-- /.box-header -->
                        <div class="box-body" id="piclist">
                            <table class="table table-bordered dataTable fontmini" id="tablelist">
                                <tr role="row" class="orders" >
                                    ...
                                    <if condition="rolemenu('News/tra_edit')">
                                ...
                                <foreach name="infolist" item="row">
                                    <tr>
                                        ...
                                        <if condition="rolemenu('News/tra_edit')">
                                            <td class="taskOptions"  style="line-height:24px;">
                                                <a href="{:U('News/tra_edit',array('id'=>$row['id'],'kind'=>$kind))}" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </if>
