...
include_once("Wxhongbao/CommonUtil.php");
include_once("Wxhongbao/SDKRuntimeException.class.php");
include_once("Wxhongbao/MD5SignUtil.php");
class WxHongBaoHelper
{
	...
	protected function get_sign(){
		define('PARTNERKEY',WxPayConf_pub::KEY);
		try {
