...
<div class="unbox">
    <div class="content">
        ...
        <div class="crumbs">
            您所在的位置：<a href="{:U('Index/home')}">首页</a> <span>&gt;</span> <a href="{:U('Index/zhichengfuwuxiangmu')}">支撑服务项目</a> <span>&gt;</span> <a href="#">展览展示</a>
        </div>

        <div class="content mt20">

            <!--<div class="prolist">-->
            <div class="prolist_jxjj">
                    ...
                    <ul>
                        <li>
                            ...
                            <div>
                                <p>科教领域 : 能源与环境</p>
                                <p>适合人群 : 初中 . 高中</p>
                                <p>简介 ：天地大冲撞给地球造成灾难，但是，冲撞也改变着地球的发展进程：正是冲撞，促使地核与地幔的形成，使地球浴火新生；也是冲撞，推动了地球发电机，</p>
                            </div>
                            <div><a href="{:U('Index/zhanlanzhanshi_detail')}" class="more">了解详情</a></div>
                        </li>
                        <li>
                            <h2>中科教box</h2>
                            <img src="__HTML__/images/zkj_box.jpg">
