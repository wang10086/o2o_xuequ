...
<head>
    ...
    <link rel="stylesheet" href="__HTML__/css/bootstrap.css">
        ...
        <div class="search">
            <div class="usertext">
                ...
                <if condition="cookie('username')">
                    <span class="us"> <a href="{:U('Member/index')}">{:cookie('username')}</a>  / <a href="{:U('Login/loginOut')}">注销</a></span>
                <else />
...
<!--<script>
    $(function(){
        window.onload = function(){
            var name = getCookie('mobile');
            var a = "<a href=\"{:U('Index/personal')}\">个人中心</a>"
            var b = "<a href=\"{:U('Login/check_login')}\">登录</a> / <a href=\"{:U('Login/register')}\">注册</a>"
            if(name != null){
                $("#rf").html(a)
            }else{
                $("#rf").html(b)
