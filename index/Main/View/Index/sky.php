...
<div class="hj_con2">
    <img src="__HTML__/images/win_holiday2.png" >
    <a class="but beijing" href="{:U('Pro/travel',array('id' =>59))}"></a>
    <a class="but hainan" href="{:U('Pro/travel',array('id' =>58))}"></a>
    <a class="but xian" href="{:U('Pro/travel',array('id' =>15))}"></a>
    <a class="but nanjing" href="{:U('Pro/travel',array('id' =>23))}"></a>
    <a class="but yunnan" href="{:U('Pro/travel',array('id' =>40))}"></a>
    <a class="but shenzhen" href="{:U('Pro/travel',array('id' =>67))}"></a>
    <a class="but xiamen" href="{:U('Pro/travel',array('id' =>66))}"></a>
    <a class="but wuhan" href="{:U('Pro/travel',array('id' =>69))}"></a>
    <a class="moreline" href="{:U('Pro/index')}"></a>
</div>
