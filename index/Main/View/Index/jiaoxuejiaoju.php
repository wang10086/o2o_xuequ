...
<div class="unbox">
    <div class="content">
        ...
        <div class="crumbs">
            您所在的位置：<a href="{:U('Index/home')}">首页</a> <span>&gt;</span> <a href="{:U('Index/zhichengfuwuxiangmu')}">支撑服务项目</a> <span>&gt;</span> <a href="#">教学教具</a>
        </div>
                ...
                <div class="plist_jxjj">
                    <ul>
                        <li>
                            ...
                            <div><a href="{:U('Index/zkj_box')}" class="more">了解详情</a></div>
                        </li>
                        <li>
                            <h2>中科教box</h2>
                            <img src="__HTML__/images/zkj_box.jpg">
