...
<div class="unbox">
    <div class="content ovhid">
        ...
        <div class="crumbs">
            您所在的位置：<a href="{:U('Index/home')}">首页</a>  <span>&gt;</span> <a href="{:U('Pro/index',array('kind'=>33))}">科学课程</a><span>&gt;</span> <a href="#">预约</a>
        </div>
        
        <h1 id="title" style="font-size:26px; font-weight:200;">{$data.title}</h1>
        
        <form class="applyform" action="{:U('Member/apply_science')}">
        	<input type="hidden" name="info[goods_id]" value="{$data.id}">
            <input type="hidden" name="info[pic]" value="{$data.pic}">
            ...
            <div class="unfrom gbg">
                ...
                <ul>
                    ...
                    <li>
                        <label>预约课程名称</label>
                        <input type="text" name="info[title]" value="{$data['title']}" readonly>
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                        <label>活动对象</label>
                    ...
                    <li>
                        <label>讲课时间</label>
                        <input type="text" name="info[in_day]" class="inputdate" placeholder="请选择讲课时间"  datatype="*6-30" value="{$date}" nullmsg="请选择讲课时间！">
                        <span class="Validform_checktip"></span>
                    </li>
