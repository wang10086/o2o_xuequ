...
<div class="unbox">
    <div class="content ovhid">
        ...
        <div class="crumbs">
            您所在的位置：<a href="{:U('Index/home')}">首页</a>  <span>&gt;</span> <a href="{:U('Zhicheng/zhicheng')}">支撑服务校(单位)建设</a><span>&gt;</span> <a href="#">支撑服务校(单位)申请</a>
        </div>
        
        <h1 id="title" style="font-size:26px; font-weight:200;">中国科学院科学教育联盟支撑服务校(单位)申请表</h1>
        
        <form class="applyform" action="{:U('Member/apply_service_edit')}">
            ...
            <div class="unfrom gbg">
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" name="info[school_name]" datatype="s4-20" nullmsg="请输入学校(单位)名称！" value="{$row.school_name}" class="fromval" >
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                        <label>负责人姓名</label>
                        <input type="text" name="info[school_master]" datatype="s2-20" nullmsg="请输入负责人姓名！" value="{$row.school_master}"  class="fromval" >
                        <span class="Validform_checktip"></span>
                    </li>
                    <li>
                    ...
                    <li>
                        <label>微信公众号</label>
                        <input type="text" name="info[wechat_num]" value="{$row.wechat_num}"  class="fromval" >
                    </li>
                    <li>
                        <label>所在省份</label>
                    ...
                    <li>
                        ...
                        <input type="text" name="info[school_addr]"  value="{$row.school_addr}"   datatype="s6-30" nullmsg="请输入学校(单位)地址！" class="fromval" >
                        <span class="Validform_checktip"></span>
                    </li>
                </ul>
            </div>
            ...
            <div class="unfrom">
                ...
                <a href="javascript:;" class="applysubmint apply_btn" >提交</a>
            </div>
